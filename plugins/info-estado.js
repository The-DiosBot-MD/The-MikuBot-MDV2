...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const wm = '> 𝑻𝒉𝒆-𝑴𝒊𝒌𝒖𝑩𝒐𝒕-𝑴𝑫𝑽2';
  const info = ` ${tradutor.texto1[0]}

  ${tradutor.texto1[1]} 𝑨𝒅𝒓𝒊𝒂𝒏𝑶𝒇𝒊𝒄𝒊𝒂𝒍
  ${tradutor.texto1[2]} +595976126756
  ${tradutor.texto1[3]} paypal.me/The-Miku-Bot-MD
