...
const connectionOptions = {
    ...
    mobile: MethodMobile,
    browser: opcion === '1' ? ['The-MikuBot-MDV2', 'Safari', '2.0.0'] : methodCodeQR ? ['The-MikuBot-MDV2', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
    auth: {
        creds: state.creds,
...
const directories = ['./MikuSession/', './jadibts/']
...
if (reason == 405) {
await fs.unlinkSync("./MikuSession/" + "creds.json")
...
setInterval(async () => {
  ...
  const bio = `• Activo: ${uptime} | The-MikuBot-MDV2`;
