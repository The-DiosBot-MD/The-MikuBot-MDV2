...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '*[ ⚠ ] Advertencia*', body: '𝚃𝚑𝚎-𝙼𝚒𝚔𝚞𝙱𝚘𝚝-𝙼𝙳', thumbnail: imagen1, sourceUrl: 'https://github.com/The-DiosBot-MD/The-MikuBot-MDV2'}}}}, aa);
